...
function renderToDiv(component: any, props: Record<string, any>): HTMLElement {
...
describe("Shape behaviors", () => {
  describe("ramp", () => {
    it("renders with a slope element", () => {
      ...
      const container = renderToDiv(VoxShape, { voxel, context });
  ...
  describe("covered shape", () => {
    it("returns null when a voxel exists directly above the shape", () => {
      ...
      const container = renderToDiv(VoxShape, { voxel: ramp, context });
  ...
  describe("cube faces", () => {
    it("renders only visible faces for an isolated cube", () => {
      ...
      const context = makeContext([voxel]);
      const container = renderToDiv(VoxCube, { voxel, context });
    ...
    it("renders no faces when cube is fully surrounded", () => {
      ...
      const container = renderToDiv(VoxCube, { voxel: center, context });
