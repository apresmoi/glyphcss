...
export interface GlyphcssOrbitControlsOptions {
...
export interface GlyphcssOrbitControlsHandle {
...
export function createGlyphcssOrbitControls(
  scene: GlyphcssSceneHandle,
  options: GlyphcssOrbitControlsOptions = {},
