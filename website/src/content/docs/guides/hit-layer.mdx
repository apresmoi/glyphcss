...
```html
<div class="glyph-hotspot" data-hotspot-id="roof"
     style="position: absolute; left: …; top: …; width: 1ch; height: 1ch">
  <span class="badge">Roof</span>
</div>
```

`left`/`top` are reassigned inline each render from the same camera projection
