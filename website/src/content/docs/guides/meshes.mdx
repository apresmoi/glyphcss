...
description: Load OBJ, glTF, GLB, STL, and MagicaVoxel VOX 3D models and render them as ASCII art with glyphcss.
---
...
These render through the scene's `mode` like any other mesh — `solid` by
default.
