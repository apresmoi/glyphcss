...
glyphcss ships a **skill** so Claude Code, Codex, Cursor, and other coding agents
can drive the CLI — ask *"render a cube in the terminal"* and the agent runs
`glyphcss cube --auto-center`.

Point your agent at it, either way:

- **From npm** — it's bundled at `node_modules/@glyphcss/compile/SKILL.md`.
- **From the web** — copy [**glyphcss.com/skill.md**](/skill.md) into your agent's
  skills folder (e.g. `.claude/skills/glyphcss/SKILL.md` for Claude Code).

> Copy `glyphcss.com/skill.md` into your Claude Code / Codex / coding agent so it
> knows how to render glyphcss shapes and meshes from the terminal.
