---
title: Render Modes
description: Compare wireframe, solid, voxel, and ink modes for rendering 3D models as ASCII art with glyphcss.
---
...
When set, `solidWeightRamp` **replaces** `glyphPalette`'s solid ramp —
...
`undefined` (the default) leaves the render byte-identical. Documented no-op
