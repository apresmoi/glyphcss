...
```tsx
<GlyphMesh geometry="icosahedron" glyphPalette="dense" ambientIntensity={0.8} mode="ink" transparent />
```
...
```vue
<GlyphMesh geometry="icosahedron" glyph-palette="dense" :ambient-intensity="0.8" mode="ink" transparent />
```
...
```html
<glyph-mesh geometry="icosahedron" glyph-palette="dense" ambient-intensity="0.8" mode="ink" transparent></glyph-mesh>
```
