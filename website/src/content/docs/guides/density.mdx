...
<GlyphMesh polygons={sprite} density={2} occlusionContourPx={16} />
```
...
<GlyphMesh :polygons="sprite" :density="2" :occlusion-contour-px="16" />
```
...
<glyph-mesh density="2" occlusion-contour-px="16" occlusion-claim="alpha"></glyph-mesh>
```
