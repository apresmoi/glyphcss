...
- **`experimentalTextureEdgeRepair`**: enabled by default to repair antialiased atlas pixels at shared textured polygon edges; set it to `false` to compare against the unrepaired atlas path. Geometry stays unchanged.
