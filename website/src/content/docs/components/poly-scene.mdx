...
(React / Vue prop names use camelCase; the `<poly-scene>` custom element accepts the kebab-case form, e.g. `atlasScale` → `atlas-scale`.)

| Prop | Type | Default | Description |
|------|------|---------|-------------|
| `directionalLight` | `PolyDirectionalLight` | — | Directional light source. |
| `ambientLight` | `PolyAmbientLight` | — | Ambient fill light. |
