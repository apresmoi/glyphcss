...
|------|------|---------|-------------|
| `perspective` | `number \| false` | `8000` | CSS perspective distance in pixels. Higher values feel flatter (more isometric); lower values exaggerate depth. `false` gives orthographic projection. |
