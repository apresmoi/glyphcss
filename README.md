...
VoxCamera exposes zoom, pan, tilt, rotation, perspective, and pointer inversion flags. VoxScene receives the voxel object and controls the 3D grid dimensions and decorations. 
